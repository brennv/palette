...
def register_commands(app):
    ...
    app.cli.add_command(commands.powermode)
    app.cli.add_command(commands.vars)
    # app.cli.add_command(commands.shredder)  # clean data
    # app.cli.add_command(commands.nuclear)   # wipe data and metadata
